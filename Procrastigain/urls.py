...
urlpatterns = patterns('',
    ...
    url(r'^listigain/(?P<task_id>\d+)/(?P<time_spent>\d+)/completed_from_listigain$', 'Listigain.views.completed_from_listigain', name='completed_from_listigain'),
    url(r'^listigain/(?P<task_id>\d+)/(?P<time_spent>\d+)/time_up_from_listigain$', 'Listigain.views.time_up_from_listigain', name='time_up_from_listigain'),
    ...
    url(r'^listigain/quad/complete$', 'Listigain.views.quad_redirect', name='quad_redirect'),
