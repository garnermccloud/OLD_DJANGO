...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Listigain_task', 'difficulty', self.gf('django.db.models.fields.CharField')(default=3, max_length=3), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 23, 22, 52, 58, 969000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 23, 22, 52, 58, 969000)'}),
