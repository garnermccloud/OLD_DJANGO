...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Task'
        db.create_table('Listigain_task', (
            ...
            ('skip', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('Listigain', ['Task'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Task'
        db.delete_table('Listigain_task')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 21, 23, 9, 43, 224000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 21, 23, 9, 43, 223000)'}),
